...
# Load local dependencies from ./libs
...
try:
    ...
    print("[-] Missing python-dotenv in local libs folder. Install with: pip install python-dotenv --target ./libs")
    sys.exit(1)

load_dotenv()

# Import pysmb from local libs
try:
    from smb.SMBConnection import SMBConnection
except ImportError:
    print("[-] Missing pysmb in local libs folder. Install with: pip install pysmb --target ./libs")
    sys.exit(1)
...
print("[+] pysmb module loaded from local libs.")
